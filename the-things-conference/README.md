...
Prepare and insert the micro SD card into the Raspberry Pi.
...
Take the remainig parts of plastic housing and insert the smaler lid into the smaler tube.
...
Connect the antenna adapter to the RAK Wireless RAK831 concentrator.
...
Attach the antenna adapter to the smaler lid and insert the smaller lid into the tube.
